...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: {
      name: `Innovecs`,
      description: `Innovecs is a globally-recognized software development company and is listed among the top 100 outsourcing companies, Inc. 5,000, and Clutch ratings.`,
  ...
  },
  {
    ...
    company: {
      name: 'Perimeter 81',
      description: `Zero Trust Network as a Service designed to simplify secure network, cloud and application access for the modern and distributed workforce.`,
  ...
  },
  {
    ...
    company: {
      ...
      description: `Cloud based transport optimization platform that utilizes smart freight exchange to improve efficiency & profitability.`,
  ...
  },
  {
    ...
    company: {
      ...
      description: `B2B website builder that features Drag & Drop / WYSIWYG editor, responsive grid, hundreds of templates, content blocks, online store and more.`,
  ...
  },
  {
    ...
    company: {
      name: 'Devster Lab',
      description: `An outsourcing company, but also a team of friends - programmers, designers, dreamers, and innovators - who understand business. Working at this company felt like being at home with my family.`,
  ...
  },
  {
    ...
    company: {
      name: 'Freelancer',
      description: `During this period of my life I worked on various projects for the university I studied in. This kick-started my career as a web developer.`,
    },
  },
];
