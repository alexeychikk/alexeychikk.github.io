...
const VerticalLayout: React.SFC<VerticalLayoutProps> = ({
  ...
  <div className={styles.fullPage}>
    {header && (
      <div id="vertical-layout-header" className={styles.header}>
        {header}
      </div>
    )}
    <div id="vertical-layout-content" className={styles.content}>
      {children}
    </div>
    {footer && (
      <div id="vertical-layout-footer" className={styles.footer}>
        {footer}
      </div>
    )}
  </div>
